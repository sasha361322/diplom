...
//        publicKeyFile  = new File(dbname + File.separator + PUBLIC_KEY_NAME);
//        privateKeyFile = new File(dbname + File.separator + "private.key");
    ...
    public byte[] decrypt(byte[] value) {
        ...
        try {
            ...
            Logger.getLogger(XImgCrypto.class.getName()).log(Level.SEVERE, null, ex);
            System.out.println("Crypt error: "+ex.getMessage());
            return null;
        }
    }
    ...
    private boolean isAES256Support() {
        ...
        try {
            ...
            System.out.println("AES256 не поддерживается установленной в системе версией java! Созданная база будет не переносима на другие системы.\n "
            ...
            System.out.println("AES256 not supported. Please, install the patch: http://www.oracle.com/technetwork/java/javase/downloads/jce8-download-2133166.html");
            return false;
        }
    }
